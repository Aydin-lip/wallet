      ...
      <ul className="flex gap-4 text-white">
        <li ref={hoverItemOne} className="py-2 cursor-pointer flex items-center gap-1 transition-all hover:text-active-them p-1">
          ...
          <div className="relative">
            <DropdownNavbar isHoverElement={isHoveringItemOne} big={true}>
        ...
        <li ref={hoverItemTwo} className="py-2 cursor-pointer flex items-center gap-1 transition-all hover:text-active-them p-1">
          صفحات
          <ChevronDownIcon className="w-4 text-neutral-400" />
          <div className="relative">
            <DropdownNavbar isHoverElement={isHoveringItemTwo} big={true}>
        ...
        <li ref={hoverItemThree} className="py-2 cursor-pointer flex items-center gap-1 transition-all hover:text-active-them p-1">
          عناصر
          <ChevronDownIcon className="w-4 text-neutral-400" />
          <div className="relative">
            <DropdownNavbar isHoverElement={isHoveringItemThree} big={true}>
              <div className="flex justify-between w-[50rem] text-white p-4 text-nowrap">
                <ul className="flex flex-col gap-4">
                  <li className={`${styleNavItems} flex items-center gap-2`}>
                    <span>
        ...
        <li ref={hoverItemFour} className="py-2 cursor-pointer flex items-center gap-1 transition-all hover:text-active-them p-1">
          وبلاگ
          <ChevronDownIcon className="w-4 text-neutral-400" />
          <div className="relative">
        ...
        <li ref={hoverItemFive} className="py-2 cursor-pointer flex items-center gap-1 transition-all hover:text-active-them p-1">
          فروشگاه
          <ChevronDownIcon className="w-4 text-neutral-400" />
          <div className="relative">
